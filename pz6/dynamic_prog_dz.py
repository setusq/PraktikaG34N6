...
print('Введите возможные прыжки кузнечика:'))
a =  int(input('прыжок вперед на: '))
b =  int(input('прыжок вперед на: '))
с =  int(input('прыжок вперед в (умножение индекса ступеньки): '))
